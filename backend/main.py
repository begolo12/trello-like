"""FastAPI Backend for Trello-like Scheduling App."""
...
DB_DSN = os.environ.get(
    "DATABASE_URL",
    "postgresql://postgres:postgres@localhost:5432/trello_like"
)
